...
NORMALIZED_FIELD_TO_SIGNAL = {
    ...
    "actual_e2e_latency_s": "e2e_latency",
    ...
    "ema_decode_tok_per_s": "throughput",
    "ema_prefill_tok_per_s": "throughput",
    "throughput_rps": "throughput",
    "concurrency": "concurrency",
    "num_running": "concurrency",
    "max_num_seqs": "concurrency",
    "batch_size": "batch_size", "sequence_length": "sequence_length",
    "prompt_tokens": "prompt_tokens", "output_tokens": "output_tokens",
    "num_prompt_tokens": "prompt_tokens",
    "num_predicted_output_tokens": "output_tokens",
    ...
    "num_waiting": "queue_depth",
    "waiting_requests_count": "queue_depth",
    "pending_prefill_tokens": "queue_depth",
    "pending_decode_tokens": "queue_depth",
    "num_preempted": "failure",
    "timeout_rate_pct": "timeout",
    "sla_violation_rate_pct": "sla",
    "status": None,  # ERROR/DEFAULT detection handled below.
    "is_failed": "failure",
    # Cache / residency.
    "cache_hit": "cache_hit", "cold_start": "cold_start",
    "prefix_id": "prefix_cache",
    "residency_state": "model_residency",
    "kv_cache_utilization": "cache_hit",
    "kv_free_blocks": "cache_hit",
    "kv_evictions_per_s": "cache_hit",
    "bucket_count": "prefix_cache",
    "reused_bucket_count": "cache_hit",
    "reuse_percentage": "cache_hit",
    "bucket_ids_hash": "prefix_cache",
    "bucket_ids_sample": "prefix_cache",
    "engine": None,
...
RAW_TO_NORMALIZED = {
    ...
    "cache_residency_trace": {
        # Aurelius internal + SwissAI bucket-reuse fields.
        "model_id": "model_id",
        "model": "model_id",
        "prefix_id": "prefix_id",
        ...
        # SwissAI per-request token-bucket reuse fields.
        "total_buckets": "bucket_count",
        "reused_buckets": "reused_bucket_count",
        "reuse_percentage": "reuse_percentage",
        "token_count": "token_count",
        "bucket_ids_hash": "bucket_ids_hash",
        "bucket_ids_sample": "bucket_ids_sample",
        # SwissAI qwen3-32b-buckets has the request-shape fields too; we
        # keep them at the cache-residency level so the file's full schema
        # is captured rather than silently dropped.
        "status": "status",
        "finished_at": "finished_at_iso",
        "finished_at_iso": "finished_at_iso",
        "reported_token_input": "prompt_tokens",
        "reported_token_output": "output_tokens",
    ...
    "telemetry_trace": {
        ...
        "status": "status",
        "is_failed": "is_failed",
        # CARA telemetry fields (vLLM scheduler state at scheduling time +
        # measured end-to-end latency after completion).
        ...
        "num_active_decode_seqs": "num_active_decode_seqs",
        "num_preempted": "num_preempted",
        "running_requests_count": "running_requests_count",
        "waiting_requests_count": "waiting_requests_count",
        "pending_prefill_tokens": "pending_prefill_tokens",
        "pending_decode_tokens": "pending_decode_tokens",
        ...
        "kv_evictions_per_s": "kv_evictions_per_s",
        "token_budget_per_iter": "token_budget_per_iter",
        "prefill_chunk_size": "prefill_chunk_size",
        "max_num_seqs": "max_num_seqs",
        "ema_decode_tok_per_s": "ema_decode_tok_per_s",
        "ema_prefill_tok_per_s": "ema_prefill_tok_per_s",
        "ema_decode_iter_ms": "ema_decode_iter_ms",
        "actual_e2e_latency": "actual_e2e_latency_s",
        "actual_ttft": "actual_ttft_s",
        "actual_tpot": "actual_tpot_s",
        "completion_timestamp": "completion_timestamp_s",
        "prediction_timestamp": "prediction_timestamp_s",
