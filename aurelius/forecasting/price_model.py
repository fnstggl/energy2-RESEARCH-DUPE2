...
class PriceQuantileForecaster:
    ...
    def save(self, path) -> None:
        ...
        an identical forecaster via PriceQuantileForecaster.load(path).
    ...
    @classmethod
    def load(cls, path) -> "PriceQuantileForecaster":
        """Load a PriceQuantileForecaster from disk.

        Args:
            path: Path previously written by save() (str or pathlib.Path).

        Returns:
            A fully reconstructed PriceQuantileForecaster ready to call predict().
